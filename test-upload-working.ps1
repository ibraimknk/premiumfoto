# PowerShell 5.1 Uyumlu Upload Script - Calisan Versiyon
# Kullanım: .\test-upload-working.ps1 -FilePath "C:\path\to\image.jpg"
...
try {
    ...
    # HttpClient otomatik olarak "multipart/form-data; boundary=..." formatini ayarlar
